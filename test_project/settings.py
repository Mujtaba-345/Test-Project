...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'postgres',
        'HOST': 'database-1.c9ay4msgitb1.us-east-1.rds.amazonaws.com',
        'PORT': 5432,
    }
}
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_TOKEN_CHECKS': [
        'rest_framework_simplejwt.token_blacklist.blacklist_all_tokens',
    ],
    "ALGORITHM": "HS256",
...
AUTHENTICATION_BACKENDS = [
    ...
    'rest_framework.authentication.TokenAuthentication',
    'utils.backends.UsernameOrEmailBackend'
]
# Password validation
